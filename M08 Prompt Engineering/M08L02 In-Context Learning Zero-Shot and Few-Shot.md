...
def build_few_shot_prompt(query: str, examples: List[dict]):
    """
    Constructs a high-resolution few-shot prompt.
    Compatible with Python 3.14.2.
    """
    # 1. Boilerplate Instruction
    base_instruction = "Classify the sentiment of the last input as POSITIVE or NEGATIVE.\n\n"
    
    # 2. Iterate through 'Demonstrations'
    shot_string = ""
    for ex in examples:
...
if __name__ == "__main__":
    ...
    user_input = "The battery life is a bit disappointing."
    
    prompt = build_few_shot_prompt(user_input, expert_examples)
    print("--- Generated Few-Shot Input ---")
    print(prompt)
```
